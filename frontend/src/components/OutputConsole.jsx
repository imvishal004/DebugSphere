...
export default function OutputConsole({
  ...
  return (
    ...
    <div className="flex flex-col h-full min-h-0 overflow-hidden">
      ...
      {/* ── Output card ────────────────────────────────────── */}
      <div className="bg-slate-900 border border-slate-700 rounded-lg flex flex-col flex-1 min-h-0 overflow-hidden">

        {/* Header */}
        <div className="flex items-center justify-between px-4 py-2 border-b border-slate-700 bg-slate-800/50 rounded-t-lg flex-shrink-0">
        ...
        <div className="p-4 font-mono text-sm overflow-auto flex-shrink-0 max-h-48 whitespace-pre-wrap">
          {isRunning && (
        ...
        {/* AI Debug Panel — inside card, scrollable */}
        {showAIPanel && (
          <div className="border-t border-slate-700 overflow-auto flex-1 min-h-0">
            <AIDebugPanel
